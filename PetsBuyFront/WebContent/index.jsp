						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner" role="listbox">
							<div class="item active">
							 <img src="./images/2.png" alt="wolfdog" class="img-responsive">
							  <div class="carousel-caption ch">
							  </div>
							</div>
							<div class="item">
							  <img src="./images/3.png" alt="cat" class="img-responsive">
							  <div class="carousel-caption ch">
							  </div>
							</div>
							<div class="item">
							   <img src="./images/1.png" alt="dog" class="img-responsive">
							  <div class="carousel-caption ch">
							  </div>
			...
			<div class="container">
				<div class="products-gallery">
					...
					<div class="col-md-3 arr">
						<div class="bg">
						  <img src="./images/a.png" alt="pet" class="img-responsive">
						  <span class="glyphicon glyphicon-heart pst" aria-hidden="true"></span>
						  <div class="caption">
							<h3>Helper Service</h3>
							<p>Find your pet helper here </p>
					...
					<div class="col-md-3 arr">
						<div class="bg">
						  <img src="./images/c.png" alt="pet" class="img-responsive">
						  <span class="glyphicon glyphicon-heart pst" aria-hidden="true"></span>
						  <div class="caption">
							<h3>Social Club</h3>
							<p>Join us find your community</p>
							<p><a href="#" class="btn btn-danger" role="button">More</a> </p>
						  </div>
						</div>
					</div>
					<div class="col-md-3 arr">
						<div class="bg">
						  <img src="./images/d.png" alt="pet" class="img-responsive">
						  <span class="glyphicon glyphicon-heart pst" aria-hidden="true"></span>
						  <div class="caption">
							<h3>Health+ Service</h3>
							<p>Book your vet here </p>
							<p><a href="#" class="btn btn-danger" role="button">More</a></p>
						  </div>
						</div>
					</div>
					<div class="col-md-3 arr">
						<div class="bg">
						  <img src="./images/b (2).png" alt="pet" class="img-responsive">
						  <span class="glyphicon glyphicon-heart pst" aria-hidden="true"></span>
						  <div class="caption">
							<h3>Mall</h3>
							<p>Get pet product here </p>
							<p><a href="#" class="btn btn-danger" role="button">More</a></p>
						  </div>
						 </div>
					</div>
					...
					<div class="traits-technology">
						<div class="col-md-8 tt">
							<ul class="traits-text">
								<li><h3>Wong Wong Platfrom</h3></li>
								<li><p><b style="font-weight:600;">Your No.1 Pet Service Platform</b></p></li>
